Pod::Spec.new do |spec|
  ...
  spec.summary      = "Facebook Adapters for mediating through Access WeMobSdk."
  ...
  spec.vendored_frameworks  = "WeMobMediation_Facebook/5.4.0.0/WeMobMediation_Facebook.framework"
