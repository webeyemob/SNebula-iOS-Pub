...
@interface WECreativeVideoConfig : NSObject
...
- (instancetype)initWithVASTResponse:(WECreativeVASTResponse *)response additionalTrackers:(NSDictionary *)additionalTrackers;
