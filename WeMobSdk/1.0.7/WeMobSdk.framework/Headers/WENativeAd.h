...
#import "WENativeAdDelegate.h"

NS_ASSUME_NONNULL_BEGIN


@interface WENativeAd : NSObject
...
/// Optional delegate object that receives state change notifications from this WENativeAd.
@property(nonatomic, weak, nullable) id<WENativeAdDelegate> delegate;
