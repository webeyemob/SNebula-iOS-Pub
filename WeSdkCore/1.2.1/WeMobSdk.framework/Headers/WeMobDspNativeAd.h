...
#import "WeMobDspNativeAdDelegate.h"

NS_ASSUME_NONNULL_BEGIN


@interface WeMobDspNativeAd : NSObject
...
/// Optional delegate object that receives state change notifications from this WeMobDspNativeAd.
@property(nonatomic, weak, nullable) id<WeMobDspNativeAdDelegate> delegate;
