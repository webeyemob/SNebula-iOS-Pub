...
#import "WeMobCreativeInterstitialDelegate.h"

typedef NS_ENUM(NSUInteger, WeMobCreativeInterstitialType) {
    WeMobCreativeInterstitialTypeHtml,
    WeMobCreativeInterstitialTypeVast
};
...
@interface WeMobCreativeInterstitial : NSObject
...
- (instancetype _Nonnull )initWithAdContent:(NSString *_Nullable)adContent andType:(WeMobCreativeInterstitialType)type;

#pragma mark Pre-Request


/// Optional delegate object that receives state change notifications from this WeMobCreativeInterstitial.
@property(nonatomic, weak, nullable) id<WeMobCreativeInterstitialDelegate> delegate;
