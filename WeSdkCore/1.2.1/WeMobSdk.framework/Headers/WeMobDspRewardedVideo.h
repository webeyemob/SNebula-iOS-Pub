...
@protocol WeMobDspRewardedVideoDelegate;

/**
 * `WeMobDspRewardedVideo` allows you to load and play rewarded video ads. All ad events are
 ...
 */
@interface WeMobDspRewardedVideo : NSObject
...
/// Optional delegate object that receives state change notifications from this WeMobDspRewardedVideo.
@property(nonatomic, weak, nullable) id<WeMobDspRewardedVideoDelegate> delegate;
...
@protocol WeMobDspRewardedVideoDelegate <NSObject>
 ...
 */
- (void)rewardedVideoAdDidLoad:(WeMobDspRewardedVideo *)ad;
 ...
 */
- (void)rewarded:(WeMobDspRewardedVideo *)ad didLoadedFailWithError: (WeMobDspAdError *)error;
 ...
 * @param ad The ad object of the ad associated with the event.
 */
- (void)rewardedVideoAdDidExpire:(WeMobDspRewardedVideo *)ad;
 ...
 */
- (void)rewardedVideoAdDidFailToPlay:(WeMobDspRewardedVideo *)ad error:(NSError *)error;
 ...
 * @param ad The ad object of the ad associated with the event.
 */
- (void)rewardedVideoAdWillAppear:(WeMobDspRewardedVideo *)ad;
 ...
 * @param ad The ad object of the ad associated with the event.
 */
- (void)rewardedVideoAdDidAppear:(WeMobDspRewardedVideo *)ad;
 ...
 * @param ad The ad object of the ad associated with the event.
 */
- (void)rewardedVideoAdWillDisappear:(WeMobDspRewardedVideo *)ad;
 ...
 * @param ad The ad object of the ad associated with the event.
 */
- (void)rewardedVideoAdDidDisappear:(WeMobDspRewardedVideo *)ad;
 ...
 * @param ad The ad object of the ad associated with the event.
 */
- (void)rewardedVideoAdWillLeaveApplication:(WeMobDspRewardedVideo *)ad;
 ...
 * @param ad The ad object of the ad associated with the event.
 */
- (void)rewardedVideoAdShouldReward:(WeMobDspRewardedVideo *)ad;
