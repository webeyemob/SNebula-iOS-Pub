...
@interface WeMobCreativeVideoConfig : NSObject
...
- (instancetype)initWithVASTResponse:(WeMobCreativeVASTResponse *)response additionalTrackers:(NSDictionary *)additionalTrackers;
