//
//  WECreativeNativeAd.h
//  WeDSPDemo
//
//  Created by 汤正 on 2019/6/18.
//  Copyright © 2019 WE. All rights reserved.
//

#import <Foundation/Foundation.h>
#import <UIKit/UIKit.h>
#import "WECreativeNativeAdDelegate.h"

NS_ASSUME_NONNULL_BEGIN


@interface WECreativeNativeAd : NSObject
...
- (id)initWithAdContent:(NSString *)adContent;

#pragma mark Pre-Request


/// Optional delegate object that receives state change notifications from this WECreativeNativeAd.
@property(nonatomic, weak, nullable) id<WECreativeNativeAdDelegate> delegate;
